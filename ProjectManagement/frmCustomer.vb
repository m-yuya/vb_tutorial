Public Class frmCustomer
    ...
    Private Sub frmCustomer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'Project_jobDataSet1.tbl_customer' table. You can move, or remove it, as needed.
        Me.Tbl_customerTableAdapter.Fill(Me.Project_jobDataSet1.tbl_customer)

    End Sub

    Private Sub FillByNameToolStripButton1_Click(sender As Object, e As EventArgs) Handles FillByNameToolStripButton1.Click
        Try
            Me.Tbl_customerTableAdapter.FillByName(Me.Project_jobDataSet1.tbl_customer, "%" & FilternameToolStripTextBox1.Text & "%")
